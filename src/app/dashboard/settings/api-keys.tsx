...
export function ApiKeys() {
  ...
  return (
    <div className="space-y-4 p-5">
      ...
      {created ? (
        <div className="rounded-lg border border-positive-100 bg-positive-100/60 p-3">
          <p className="text-sm font-medium text-ink-900">Copy this key now — it is shown once.</p>
          ...
          <button
            ...
            className="mt-2 text-xs font-medium text-ink-600 hover:text-ink-900"
          >
            I have saved it
          </button>
        </div>
          ...
          {keys.map((key) => (
            <li key={key.id} className="flex flex-wrap items-center justify-between gap-3 px-4 py-3">
              ...
              <button
                ...
                className="text-sm font-medium text-danger-600 hover:opacity-80"
              >
                Revoke
              </button>
            </li>
